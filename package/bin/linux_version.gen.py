...
while count < iterations:
	...
	event = '@@date machine_hardware_name="x86_64" machine_architecture_name="x86_64" os_release="2.6.21.7-2.ec2.v1.2.fc8xen" os_name="Linux" os_version="#1 SMP Fri Nov 20 17:48:28 EST 2009"'
