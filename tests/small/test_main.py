...
def test_parse_cli_vars(config):
    ...
    assert obj == {
        "AMQP_URI": "pyamqp://user:pass@host:port",
        "AMQP_HOST": "hostname",
        "AMQP_PORT": 8001,
        "AMQP_WEBPORT": 8000,
        "AMQP_USER": "hello",
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({
            "EVENTGEN_AMQP_URI": "test",
            "EVENTGEN_AMQP_HOST": "host",
            "EVENTGEN_AMQP_PORT": 8000,
            "EVENTGEN_AMQP_WEBPORT": 8001,
            "EVENTGEN_AMQP_USER": "hello",
            "EVENTGEN_AMQP_PASS": "world",
